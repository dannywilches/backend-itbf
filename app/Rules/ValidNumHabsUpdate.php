...
class ValidNumHabsUpdate implements DataAwareRule, ValidationRule
{
    /**
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        ...
        $valid_num_habs = Habitaciones::where('id_hotel', $this->data["id_hotel"])->where('id', '<>', $this->data["id_asignacion"])->get()->sum('num_habs');
