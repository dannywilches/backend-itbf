...
use App\Rules\ValidNumHabsCreate;
use App\Rules\ValidRepeatCreate;
...
class StoreHabitacionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'id_hotel' => ['required'],
            'num_habs' => ['required','numeric','min:1', new ValidNumHabsCreate],
            'tipo_hab' => ['required', new ValidRepeatCreate],
            'acomodacion' => ['required', new ValidRepeatCreate],
        ];
    }
